 ...
 * at all — Escape, the scrim, «فهمت» — counts as having been offered.
 */
...
export function Walkthrough({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="overlay" role="dialog" aria-modal="true" aria-label="كيف تتم المساجلة" onClick={onClose}>
