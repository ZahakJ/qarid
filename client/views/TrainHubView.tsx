                ...
                <ul className="weak__list">
                  {weakest.map((s) => (
                    <li key={s.letter}>
                      ...
                      {/* «ذاكِر», not «تدرّب»: the screen this opens calls
                          itself المذاكرة, and التدريب is already the duel's
                          «وضع التدريب». A link, so it can be opened in a new
                          tab and so its accessible name carries the letter. */}
                      <a
