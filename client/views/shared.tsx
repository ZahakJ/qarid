...
/* «بلا عنوان» now lives in shared/constants.ts — the server's share head needs
   the same rule — and is re-exported here, where this view's callers look. */
export { UNTITLED } from "../../shared/constants.ts"
