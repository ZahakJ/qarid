...
const VERDICTS: { tag: string; copy: string; cost: string }[] = [
  { tag: "ليس الحرف المطلوب", copy: "بيتك لا يبدأ بالحرف المطلوب.", cost: "لا شيء — البيت يبقى في الحقل" },
  ...
  { tag: "أهذا ما أردتَ؟", copy: "وجدتُ بيتًا يشبهه شبهًا بعيدًا.", cost: "تقبله بخمسٍ وعشرين نقطة" },
