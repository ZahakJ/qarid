    ...
    <div className="view diwans-view">
      ...
      {error && status === "error" ? (
        ...
        <EmptyState flavor="no-favorites" title="لا ديوان لك بعد">
          <p className="diwans-empty">
            كان لكلّ شاعرٍ ديوانٌ جمعه له راوٍ أو جمعه لنفسه. هذا دورك: افتح قصيدةً وانقر «أضِف القصيدة إلى
            ديوان»، أو «أضِف إلى ديوان» تحت بيتٍ بعينه — أو سَمِّ ديوانك أوّلًا وامْلأه بعدُ.
          </p>
